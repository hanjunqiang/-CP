        ...
        flux.browser = {
            init: function() {
                if (void 0 === flux.browser.supportsTransitions) {
                    ...
                    if (flux.browser.supportsTransitions = window.Modernizr && void 0 !== Modernizr.csstransitions ? Modernizr.csstransitions : this.supportsCSSProperty("Transition"), window.Modernizr && void 0 !== Modernizr.csstransforms3d)
...
var eqxiu = function() {
    function a(a) {
        m = !0;
        for (var e, f = 0, g = d._pageData.length; g > f; f++)
            a == d._pageData[f].id && (e = d._pageData[f].num);
        e || (e = a);
        ...
        v = function(a, b, c, j) {
            ...
            function K(a, b, c, e) {
                if (d.$activePage && (d.$activePage.classList.remove("z-active"), d.$activePage.classList.remove("z-move")), d.$activePage && d.$activePage.classList.contains("main-page")) {
                    ...
                    v(d.$currentPage.style, "Transform", c + "(0px) scale(1)")
            }
            ...
            function M(a, b) {
                if ("1" == b || "3" == b)
                    w($(d.$currentPage), "transform", "scale(0.2)");
                else if ("5" == b) {
                    var c = q > 0 ? "" : "-";
                    w($(d.$currentPage), "transform", "translateX(" + c + h + "px)")
                } else
                    w($(d.$currentPage), "transform", "scale(1)");
            ...
            this._$app = a, this._$pages = this._$app.find(".main-page"), this.$currentPage = this._$pages.eq(0), this.$activePage = null, this._isFirstShowPage = !0, this._isInitComplete = !1, this._isDisableFlipPage = !1, this._isDisableFlipPrevPage = !1, this._isDisableFlipNextPage = !1, this._scrollMode = b, this._pageData = c, this.pageData = j, b = b, d = this, h = n ? window.innerWidth : $(".nr").width(), i = n ? window.innerHeight : $(".nr").height(),
                    ...
                    if (a && "mousemove" == a.type ? (q = a.pageX - o, r = a.pageY - p) : a && "touchmove" == a.type && (q = a.touches[0].pageX - o, r = a.touches[0].pageY - p), !firstTrigger && (Math.abs(q) > 20 || Math.abs(r) > 20)) {
                        if (d.$activePage) {
                            ...
                            $(d.$activePage).find("li").each(function() {
                                for (var a = 0; a < d._pageData[e - 1].elements.length; a++)
                                    d._pageData[e - 1].elements[a].id == parseInt($(this).attr("id").substring(7), 10) && eqxCommon.animation($(this), c[e - 1].elements[a], "view")
                            })
                        }
                        firstTrigger = !0
                    }
                ...
                if (s && x())
                    if (s = !1, d.$activePage) {
                        ...
                        var a;
                        a = "6" == b || "7" == b ? "cubic-bezier(0,0,0.99,1)" : "linear", d.$currentPage.style.webkitTransition = "-webkit-transform .4s " + a, d.$activePage.style.webkitTransition = "-webkit-transform .4s " + a, d.$currentPage.style.mozTransition = "-moz-transform .4s " + a, d.$activePage.style.mozTransition = "-moz-transform .4s " + a, d.$currentPage.style.transition = "transform .4s " + a, d.$activePage.style.transition = "transform .4s " + a, "0" == b || "2" == b || "1" == b ? A() : "4" == b || "3" == b ? C() : "5" == b ? E() : "6" == b ? G() : "7" == b && I()
                    } else
                        d.$currentPage.classList.remove("z-move");
                m = !1
            }, $(document).on("flipend", function() {
                setTimeout(function() {
...
! function(a, b) {
    ...
    function e(a, c) {
        ...
        i.addClass("active"), d = i.val(), b("#reportList").find("li").click(function() {
    ...
    function(a, b) {
        function c(a, c) {
            var d = '{"id":"","sceneId":"","num":2,"name":null,"properties":null,"elements":[{"id":439880,"pageId":129810,"sceneId":16060,"num":0,"type":"3","isInput":0,"title":null,"content":null,"status":1,"css":{},"properties":{"bgColor":"#E6E9EE"}},{"id":439881,"pageId":129810,"sceneId":16060,"num":1,"type":"2","isInput":0,"title":null,"content":"<div style=\\"text-align: center;\\"><span style=\\"line-height: 1; background-color: initial;\\"><font size=\\"4\\" color=\\"#888888\\"><b>场景名称</b></font></span></div>","status":1,"css":{"height":"65","zIndex":"10","width":"320","left":"0px","top":"77px"},"properties":{"height":"65"}},{"id":439882,"pageId":129810,"sceneId":16060,"num":1,"type":"4","isInput":0,"title":null,"content":null,"status":1,"css":{"borderRadius":"10px","borderStyle":"solid","zIndex":"9","borderColor":"rgba(0,0,0,1)","paddingTop":"0px","height":"141","backgroundColor":"","color":"","boxShadow":"0px 0px 0px #333333","borderWidth":"0px","width":"142.13709677419354","left":"92px","paddingBottom":"0px","top":"177px"},"properties":{"height":"100px","imgStyle":{"width":142,"height":142,"marginTop":"-0.5px","marginLeft":"0px"},"width":"100px","src":"group1/M00/BA/DA/yq0KA1Rq8COAAYRjAAKU4OVYum0889.jpg"}},{"id":439883,"pageId":129810,"sceneId":16060,"num":1,"type":"4","isInput":0,"title":null,"content":null,"status":1,"css":{"height":"16","zIndex":"11","width":"280","left":"21px","top":"122px"},"properties":{"height":"100px","imgStyle":{"width":280,"height":73,"marginTop":"-24px","marginLeft":"0px"},"width":"100px","src":"' + CLIENT_CDN + 'view/images/line.png"}},{"id":439885,"pageId":129810,"sceneId":16060,"num":1,"type":"2","isInput":0,"title":null,"content":"<div style=\\"text-align: center;padding-top: 0;\\"><span style=\\"font-size: small; line-height: 1; background-color: initial;\\"><a href=\\"' + PREFIX_S1_URL + "eqs/link?id=16060&amp;url=" + encodeURIComponent(h) + '\\" target=\\"_blank\\"><font color=\\"#888888\\">免费创建一个场景？→</font><font color=\\"#23a3d3\\">易企秀</font></a></span></div>","status":1,"css":{"borderRadius":"0px","borderStyle":"solid","height":"30","paddingTop":"0px","borderColor":"rgba(222,220,227,1)","zIndex":"12","boxShadow":"0px 0px 0px rgba(200,200,200,0.6)","color":"","backgroundColor":"rgba(255,255,255,0)","borderWidth":"0px","width":"320","left":"1px","paddingBottom":"20px","top":"420px"},"properties":{"anim":{"type":1,"direction":3,"duration":"1","delay":"0.6"}}}]}',
                ...
                f = '{"id":81465,"pageId":"","sceneId":"","num":1,"type":"2","isInput":0,"title":null,"content":"<div style=\\"text-align: center;\\"><font color=\\"#ffffff\\" size=\\"3\\">击此处进行编辑</font></div>","status":1,"css":{"zIndex":"102","height":"65","width":"320","left":"0px","top":"70px"},"properties":{"height":"65"}}';
            if (m = 1, a.obj.property.lastPageId)
                n = !0, b.ajax({
                    ...
                    success: function(b) {
                        if (!b.obj) {
                            ...
                            var i = JSON.parse(d);
                            return i.num = a.list.length + 1, i.elements[2].properties.src = a.obj.cover, i.elements[1].properties.height = 65, i.elements[1].height = 65, i.elements[1].content = i.elements[1].content.replace(/场景名称/, a.obj.name), a.list.push(i), void g(c, a)
                        }
                ...
                d = d.replace(/id=16060/, "id=" + a.obj.id);
                var i = JSON.parse(d);
                i.num = a.list.length + 1, i.elements[2].properties.src = a.obj.cover, i.elements[1].content = i.elements[1].content.replace(/场景名称/, a.obj.name), a.list.push(i), g(c, a)
            }
        }
        ...
        function g(c, d) {
            for (var e = [], f = !1, g = {
                ...
                if (b('<section class="main-page"><div class="m-img" id="page' + h + '"></div></section>').appendTo(".nr"), c.length > 1 && (0 == j || 1 == j || 2 == j ? b('<section class="u-arrow-bottom"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow.png" /></section>').appendTo("#page" + h) : (3 == j || 4 == j || 5 == j) && b('<section class="u-arrow-right"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow_right.png" /></section>').appendTo("#page" + h)), 1 == h && (b(".loading").hide(), b(".main-page").eq(0).addClass("z-current")), c[h - 1].properties && !b.isEmptyObject(c[h - 1].properties) ? c[h - 1].properties.image || c[h - 1].properties.scratch ? p.scratch ? addScratchEffect(c, h) : ! function(a) {
                    b.getScript(CLIENT_CDN + "view/js/scratch_effect.js", function() {
                        p.scratch = !0, addScratchEffect(g, c, a)
                    })
                }(h) : c[h - 1].properties.finger ? (e.push({
                    num: h,
                    finger: c[h - 1].properties.finger
                }), f || (f = !0, b.getScript(CLIENT_CDN + "view/js/lock_effect.js", function() {
                    test(g, c, e, b(".m-img").width(), b(".m-img").height())
                }))) : c[h - 1].properties.fallingObject ? p.fallingObject ? fallingObject(c, h) : ! function(a) {
                    b.getScript(CLIENT_CDN + "view/js/falling_object.js", function() {
    ...
    function(window, $) {
        ...
        function bindShare(data) {
            if (mobilecheck())
                isWeixin() && (imgUrl = PREFIX_FILE_HOST + data.obj.cover, shareTitle = data.obj.name, descContent = data.obj.description, descContent || (descContent = ""));
            else
        ...
        function parseJson(a) {
            document.title = a.obj.name, $("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由易企秀免费移动场景应用自营销管家提供技术支持"), $(".scene_title").html(a.obj.name), pageMode = a.obj.pageMode;
            var b = [];
            return a.obj.property && (a.obj.property = JSON.parse(a.obj.property) || {}), a.obj.bgAudio && (a.obj.bgAudio = JSON.parse(a.obj.bgAudio) || null), b = a.list, b.length <= 0 ? (alert("此场景不存在!"), void(window.location.href = "http://eqxiu.com")) : (appendLastPage(a, b, pageMode, preview, param, ad), void bindShare(a))
        }
                ...
                addElmentsForPc = function(a) {
                    ...
                    c.href = CLIENT_CDN + "common/css/pcviewer.css", c.rel = "stylesheet", b.appendChild(c), window != window.top ? $("body").css("background-image", "none") : (getBg(), $.getScript(CLIENT_CDN + "common/js/qrcode.js", function() {
                        $.getScript(CLIENT_CDN + "common/js/jquery.qrcode.js", function() {
                            ...
                            var b;
                            b = parseInt(10 * Math.random(), 10) % 2 ? PREFIX_HOST : PREFIX_HOST1, $("#codeImg").qrcode({
                                render: "canvas",
                                width: 200,
                                height: 200,
